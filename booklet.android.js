...
import { BookletListView } from "./BookletList";
import { AndroidPDFWebView } from "./AndroidPDFWebView";
                ...
                <Navigator
                    ...
                    renderScene={(route, navigator) => {
                        switch (route.id) {
                            case "BOOKLET_ROOT":
                                return (
                                    <BookletListView navigator={navigator} />
                                );
                            case "BOOKLET_PDF":
                                return (
                                    <AndroidPDFWebView
                                        source={route.passProps.source}
                                    />
                                );
                            case "FEEDBACK_FORM":
                                return (
                                    <WebView source={route.passProps.source} />
                                );
                            default:
