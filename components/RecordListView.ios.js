...
import { RecordObservable } from "../lib/api";
    ...
    <View>
      <View style={styles.row}>
        <View style={styles.left}>
          <Text style={record.audio === "" ? styles.noAudioText : {}}>{record.date}</Text>
          <Text style={record.audio === "" ? styles.noAudioText : {}}>{record.session}</Text>
        </View>
        <View style={styles.right}>
          <Text style={record.audio === "" ? styles.noAudioText : {}}>{record.content}</Text>
        </View>
      </View>
    </View>
  </TouchableHighlight>
